...
Some before-timed instructions cannot be resumed safely while preserving
continuous monitoring. The backend then deactivates the watchpoint and sets
:c:member:`k_watchpoint_event.rearm_required`. Defer re-arming to supervisor
